namespace HospitalManagementSystem.Model
{
    partial class TransactionHistoryItem
    {
        ...
        private void InitializeComponent()
        {
            ...
            paymentMethodLb = new Label();
            feeLb = new Label();
            amountLb = new Label();
            label12 = new Label();
            transactionDateLb = new Label();
            label14 = new Label();
            appointmentDateLb = new Label();
            textLb = new Label();
            statusLb = new Label();
            appointmentTypeLb = new Label();
            label8 = new Label();
            label7 = new Label();
            patientNameLb = new Label();
            SuspendLayout();
            // 
            // label1
            // 
            ...
            transactionDateLb.Text = "05/30/2025";
            // 
            // label14
            // 
            ...
            appointmentDateLb.Text = "05/30/2025";
            // 
            // textLb
            // 
            ...
            patientNameLb.Text = "Patient Name: ";
            // 
            ...
            Controls.Add(textLb);
            Controls.Add(appointmentDateLb);
            Controls.Add(label14);
            Controls.Add(transactionDateLb);
            Controls.Add(label12);
            Controls.Add(amountLb);
            Controls.Add(feeLb);
            Controls.Add(paymentMethodLb);
        ...
        private Label transactionDateLb;
        private Label label14;
        private Label appointmentDateLb;
        private Label textLb;
        private Label statusLb;
        private Label appointmentTypeLb;
