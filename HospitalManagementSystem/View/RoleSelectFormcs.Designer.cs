namespace HospitalManagementSystem.View
{
    partial class RoleSelectFormcs
    {
        ...
        private void InitializeComponent()
        {
            ...
            label4.TabIndex = 9;
            label4.Text = "Welcome to Hospital System";
            // 
            // label5
            // 
            ...
            label5.TabIndex = 10;
            label5.Text = "Select Account to Login";
            // 
            // RoleSelectFormcs
            // 
            AutoScaleDimensions = new SizeF(7F, 15F);
            AutoScaleMode = AutoScaleMode.Font;
            ClientSize = new Size(966, 523);
            Controls.Add(label5);
            Controls.Add(label4);
